...
const App = () => {
  ...
  const buttonClick = () => {
    ...
    // console.log(inputError.inputName);
    // console.log(inputError.inputEmail);
    // console.log(inputError.inputGender);
    // console.log(inputError.inputNumber);
    // console.log(inputError.inputPass);
